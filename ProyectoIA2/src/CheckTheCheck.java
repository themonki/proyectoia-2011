...
public class CheckTheCheck {
 	            ...
 	            for(int j=0; j<6; j++) {
 	                ...
 	                switch(Character.toUpperCase(actual)) {//convierte la letra a mayuscula y busca el caso correspondiente
 	                    ...
 	                    case 'P': //peon
 	                        ...
 	                        if(recorrido1pasoExpandir(i,j, dxPeon, dyPeon, signX))
 	                            amenazante=actual;
 	                    break;
	...
	static boolean recorrido1pasoExpandir(int x, int y, int[] dx, int[] dy, int signoX) {
	    ...
	    for(int dir=0; dir<dx.length; dir++) {
	        ...
	        if (valid(xx,yy) && dy[dir]==0 && tablero[xx][yy]=='.')// en caso de que se pueda mover a su frente 
	        {
